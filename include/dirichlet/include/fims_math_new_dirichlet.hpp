/**
 * @file fims_math_new_dirichlet.hpp 
...
namespace fims_math
{
  ...
  /**
   * @brief Calculate the linear parameterization of the Dirichlet-Multinomial distribution
...
/**
   * @brief Calculate the saturated parameterization of the Dirichlet-Multinomial distribution
   * and return the loglikelihood or likelihood value
   *
   * @param x A vector of observed counts by catergory.
   * @param p A vector of observed proportions by catergory.
